...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1>Offices</h1>
                <small><a href="{{route("admin.home")}}">Dashboard</a> > Offices</small>
            </div>
        </div>
        <!-- /.col-md-12 -->
    </div>
                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('admin.office.add')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea type="text" class="form-control" name="contact" id="contact" placeholder="Kontak" required></textarea><br>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
    ...
    <script>
            ...
            columns: [
                ...
                { data: "id", render : function (data, type, row ) {
                    return "" +
                        ...
                        "<a class='edit-detail' href='{{route("admin.office.detail")}}/"+data+"' style='color: white; text-decoration: none' ><button type='button' class='btn btn-success btn-sm'><i class='fa fa-eye'></i></button></a>"+
                        "<a class='confirm-delete' href='{{route("admin.office.delete")}}/"+data+"' style='color: white; text-decoration: none' ><button type='button' class='btn btn-danger btn-sm' class='confirm-delete' ><i class='fa fa-trash'></i></button></a>"+
                        "</div>";
                }}
        ...
        $(document).on("click",".view-content",function () {
            ...
            $.ajax({
                url: '{{route("admin.office.ajax",["action"=>"content"])}}',
                type: 'get',
                dataType: "json",
                data: {
                    id: $(this).data("id"),
                ...
                success: function( data, textStatus, jQxhr ){
                    if (data.status) {
                        ...
                        notify("warning","Gagal!","Tidak ada data")
                    }
                }
            });
        });
