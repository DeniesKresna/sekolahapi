        ...
        <div class="col-md-12">
            <div class="col-md-12">
                <div class="page-header">
                    <h1>{{$data->name}}</h1>
                    <small><a href="{{route("admin.home")}}">Dashboard</a> > <a href="{{route("admin.research_field")}}">Bidang Penelitian</a> > {{$data->name}}</small>
                </div>
            </div>
        </div>
        <!-- /.col-md-12 -->
        ...
        <div class="col-md-offset-2 col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('admin.research_field.update')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="description"  value="{{$data->description}}"  placeholder="Deskripsi" required><br>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
